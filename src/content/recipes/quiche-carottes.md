...
directions:
  ...
  - step: Préparation de l’appareil aux carottes
    list:
      ...
      - Cuire à la vapeur environ 20 mins ou plus (les carottes doivent être suffisamment fondantes).
      - Transvaser les rondelles dans le robot puis saler, poivrer, ajouter la noix de muscade et les herbes de Provence. Attendre un peu que les rondelles de carottes tiédissent.
      - Mixer les rondelles en purée à l’aide des œufs.
  - step: Montage
    list:
      - Préchauffer le four à 200°C (chaleur tournante).
      - Sur un plan légermement fariné, étaler la pâte brisée à l’aide d’un rouleau à patisserie. Transférer la pâte dans un moule à tarte de 28 cm afin de la foncer.
